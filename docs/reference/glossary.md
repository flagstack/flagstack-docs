...
**Client credential**  
A deliberately-public `syoc_client_...` environment credential. It receives only client-visible flags.
...
**Organisation**  
Top-level Switch On Your Code tenant and membership boundary.
...
**Server credential**  
A secret `syoc_server_...` environment credential for trusted backend code.
